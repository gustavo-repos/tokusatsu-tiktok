...
exports.EnemyScript = exports.time = void 0;
const Game_1 = require("Game");
exports.time = 35;
let EnemyScript = class EnemyScript extends APJS.BasicScriptComponent {
    constructor() {
        super(...arguments);
        this.accumulator = 0;
        this.spawnTimer = 0;
...
EnemyScript = __decorate([
    component()
], EnemyScript);
exports.EnemyScript = EnemyScript;
